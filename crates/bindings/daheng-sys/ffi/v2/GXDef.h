...
{
    GX_LOG_TYPE_OFF   = 0x00000000,							///< \Chinese 所有类型均发送\不发送     \English All types are sent \ Not sent
    GX_LOG_TYPE_FATAL = 0x00000001,							///< \Chinese FATAL类型               \English log type: fatal
    GX_LOG_TYPE_ERROR = 0x00000010,							///< \Chinese ERROR类型               \English log type: error
    GX_LOG_TYPE_WARN  = 0x00000100,							///< \Chinese WARN类型                \English log type: warning
    GX_LOG_TYPE_INFO  = 0x00001000,							///< \Chinese INFO类型                \English log type: info
    GX_LOG_TYPE_DEBUG = 0x00010000,							///< \Chinese DEBUG类型               \English log type: debug
    GX_LOG_TYPE_TRACE = 0x00100000,							///< \Chinese TRACE类型               \English log type: trace
}GX_LOG_TYPE_LIST;
