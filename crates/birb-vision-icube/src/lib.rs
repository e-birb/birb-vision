use std::{ffi::c_char, marker::PhantomData, ops::{Deref, RangeInclusive}, sync::Mutex};
...
impl iCubeDevice {
    ...
    pub fn start_video_stream(&self, preview: bool, callback: bool) -> Result<(), iCubeError> {
        unsafe {
            match self.handle.ctx.sdk() {
                SDK::V1(api) => (api.Start)(*self.handle as _).v1_result(),
                SDK::V2(api) => (api.Start)(*self.handle, std::ptr::null_mut(), preview as _, callback as _).v2_result(),
            }
        }
    }
    ...
    pub fn is_video_streaming(&self) -> Option<bool> {
        unsafe {
            match self.handle.ctx.sdk() {
                SDK::V1(_) => None,
                SDK::V2(api) => Some(match (api.IsStarted)(*self.handle) {
                    v2::ON => true,
                    v2::OFF => false,
    ...
    pub fn get_frame_size(&self) -> Result<(i32, i32), iCubeError> {
        ...
        unsafe {
            match self.handle.ctx.sdk() {
                SDK::V1(api) => (api.GetSize)(*self.handle as _, &mut width, &mut height).v1_result()?,
                SDK::V2(api) => (api.GetSize)(*self.handle, &mut width, &mut height).v2_result()?,
            }
        }
        Ok((width, height))
    }
    ...
    pub fn get_broken_frames(&self) -> Result<i32, iCubeError> {
        ...
        unsafe {
            match self.handle.ctx.sdk() {
                SDK::V1(api) => {
                    let mut count = 0;
                    (api.GetBrokenFrames)(*self.handle as _, &mut count).v1_result()?;
                    Ok(count as _)
                },
                SDK::V2(api) => {
                    let mut count = 0;
                    (api.GetBrokenFrames)(*self.handle, &mut count).v2_result()?;
                    Ok(count)
                },
            }
        }
    ...
    pub fn get_good_frames(&self) -> Result<i32, iCubeError> {
        ...
        unsafe {
            match self.handle.ctx.sdk() {
                SDK::V1(api) => {
                    let mut count = 0;
                    (api.GetGoodFrames)(*self.handle as _, &mut count).v1_result()?;
                    Ok(count as _)
                },
                SDK::V2(api) => {
                    let mut count = 0;
                    (api.GetGoodFrames)(*self.handle, &mut count).v2_result()?;
                    Ok(count)
                },
            }
        }
    ...
    pub fn set_display_mode(
        ...
        unsafe {
            match self.handle.ctx.sdk() {
                ...
                SDK::V2(api) => (api.SetDisplayMode)(*self.handle, mode as _, properties.into_sdk_struct_v2()).v2_result(),
            }
        }
    }
...
//
        ...
        unsafe {
            match self.handle.ctx.sdk() {
                ...
                SDK::V2(api) => {
                    ...
                    (api.GetVersion)(*self.handle, version.as_mut_ptr());
    ...
    pub fn get_firmware_version(&self) -> Result<String, iCubeError> {
        ...
        unsafe {
            match self.handle.ctx.sdk() {
                ...
                SDK::V2(api) => {
                    let mut version = [0i8; v2::NETCAM_VERSION_LENGTH as usize];
                    (api.GetFWVersion)(*self.handle, version.as_mut_ptr());
                    Ok(arr_to_str(&version))
                },
            }
        }
        ...
        unsafe {
            match self.handle.ctx.sdk() {
                ...
                SDK::V2(api) => {
                    ...
                    (api.GetSerialNum)(*self.handle, serial.as_mut_ptr());
    ...
    pub fn get_fpga_version(&self) -> Result<String, iCubeError> {
        ...
        unsafe {
            match self.handle.ctx.sdk() {
                ...
                SDK::V2(api) => {
                    let mut version = [0i8; v2::NETCAM_VERSION_LENGTH as usize];
                    (api.GetFGPAVersion)(*self.handle, version.as_mut_ptr());
                    Ok(arr_to_str(&version))
                },
            }
        }
    ...
    pub fn set_roi_property(&self, roi: RoiProperty) -> Result<(), iCubeError> {
        ...
        unsafe {
            match self.handle.ctx.sdk() {
                SDK::V1(api) => (api.SetResolution)(*self.handle as _, roi.width, roi.height, roi.x, roi.y).v1_result(), // TODO enable missing!!!
                SDK::V2(api) => (api.SetResolution)(*self.handle, &mut roi.to_sdk_struct_v2()).v2_result(),
            }
        }
    }
        ...
        unsafe {
            match self.handle.ctx.sdk() {
                SDK::V1(api) => {
                    ...
                    let mut width = 0;
                    let mut height = 0;
                    (api.GetResolution)(*self.handle as _, &mut width, &mut height, &mut x, &mut y).v1_result()?;
                    Ok(RoiProperty {
                        enabled: true,
                        x,
                        y,
                ...
                SDK::V2(api) => {
                    ...
                    (api.GetResolution)(*self.handle, &mut roi).v2_result()?;
        ...
        unsafe {
            match self.handle.ctx.sdk() {
                SDK::V1(api) => {
                    ...
                    (api.GetResolutionRange)(*self.handle as _, &mut roi_range).v1_result()?;
                    Ok(RoiRange {
                        width_range: roi_range.nXMin..=roi_range.nXMax,
                        height_range: roi_range.nYMin..=roi_range.nYMax,
                    })
                ...
                SDK::V2(api) => {
                    ...
                    (api.GetResolutionRange)(*self.handle, &mut roi_range).v2_result()?;
                    Ok(RoiRange {
                        width_range: roi_range.nXMin..=roi_range.nXMax,
                        height_range: roi_range.nYMin..=roi_range.nYMax,
                    })
    ...
    pub fn set_mode(&self, resolution_mode: &ResolutionMode) -> Result<(), iCubeError> {
        ...
        unsafe {
            match self.handle.ctx.sdk() {
                SDK::V1(api) => (api.SetMode)(*self.handle as _, resolution_mode.into_sdk_value_v1()? as _).v1_result(),
                SDK::V2(api) => (api.SetMode)(*self.handle, resolution_mode.into_sdk_value_v2()).v2_result(),
            }
        }
    }
    ...
    pub fn get_mode(&self) -> Result<ResolutionMode, iCubeError> {
        ...
        unsafe {
            match self.handle.ctx.sdk() {
                SDK::V1(api) => {
                    let mut mode = 0;
                    (api.GetMode)(*self.handle as _, &mut mode).v1_result()?;
                    Ok(ResolutionMode::from_sdk_value_v1(mode as _))
                },
                SDK::V2(api) => {
                    let mut mode = 0;
                    (api.GetMode)(*self.handle, &mut mode).v2_result()?;
        ...
        unsafe {
            match self.handle.ctx.sdk() {
                SDK::V1(api) => {
                    let mut modes = vec![0; 255];
                    let mut count = 0;
                    (api.GetModeList)(*self.handle as _, modes.as_mut_ptr(), &mut count).v1_result()?;
                    modes.truncate(count as usize);
                ...
                SDK::V2(api) => {
                    let mut modes = vec![0; 255];
                    let mut count = 0;
                    (api.GetModeList)(*self.handle, modes.as_mut_ptr(), &mut count).v2_result()?;
                    modes.truncate(count as usize);
    ...
    pub fn set_bin_skip(&self, mode: BinOrSkipMode, param: BinSkipParameter) -> Result<(), iCubeError> {
        ...
        unsafe {
            match self.handle.ctx.sdk() {
                SDK::V1(api) => (api.SetBinSkip)(*self.handle as _, param.into_sdk_value_v1() as _, mode.into_sdk_value_v1()).v1_result(),
                SDK::V2(api) => (api.SetBinSkip)(*self.handle, param.into_sdk_value_v2(), mode.into_sdk_value_v2()).v2_result(),
            }
        }
    }
    ...
    pub fn get_bin_skip(&self, mode: BinOrSkipMode) -> Result<BinSkipParameter, iCubeError> {
        ...
        unsafe {
            match self.handle.ctx.sdk() {
                SDK::V1(api) => {
                    let mut param = 0;
                    (api.GetBinSkip)(*self.handle as _, &mut param, mode.into_sdk_value_v1()).v1_result()?;
                    Ok(BinSkipParameter::from_sdk_value_v1(param as _))
                },
                SDK::V2(api) => {
                    let mut param = 0;
                    (api.GetBinSkip)(*self.handle, &mut param, mode.into_sdk_value_v2()).v2_result()?;
        ...
        unsafe {
            match self.handle.ctx.sdk() {
                SDK::V1(api) => {
                    let mut params = vec![0; 255];
                    let mut count = 0;
                    (api.GetBinSkipList)(*self.handle as _, mode.into_sdk_value_v1() as _, params.as_mut_ptr(), &mut count).v1_result()?;
                    params.truncate(count as usize);
                ...
                SDK::V2(api) => {
                    let mut params = vec![0; 255];
                    let mut count = 0;
                    (api.GetBinSkipList)(*self.handle, mode.into_sdk_value_v2(), params.as_mut_ptr(), &mut count).v2_result()?;
                    params.truncate(count as usize);
    ...
    pub fn save_to_file(&self, path: &str) -> Result<(), iCubeError> {
        ...
        unsafe {
            match self.handle.ctx.sdk() {
                SDK::V1(api) => (api.SaveToFile)(*self.handle as _, path.as_ptr()).v1_result(),
                SDK::V2(api) => (api.SaveToFile)(*self.handle, path.as_ptr()).v2_result(),
            }
        }
    }
    ...
    pub fn set_trigger(&self, mode: TriggerMode) -> Result<(), iCubeError> {
        ...
        unsafe {
            match self.handle.ctx.sdk() {
                SDK::V1(api) => (api.SetTrigger)(*self.handle as _, mode.into_sdk_value_v1()? as _).v1_result(),
                SDK::V2(api) => (api.SetTrigger)(*self.handle, mode.into_sdk_value_v2()).v2_result(),
            }
        }
    }
    ...
    pub fn get_trigger(&self) -> Result<TriggerMode, iCubeError> {
        ...
        unsafe {
            match self.handle.ctx.sdk() {
                SDK::V1(api) => {
                    let mut mode = 0;
                    (api.GetTrigger)(*self.handle as _, &mut mode).v1_result()?;
                    Ok(TriggerMode::from_sdk_value_v1(mode as _))
                },
                SDK::V2(api) => {
                    let mut mode = 0;
                    (api.GetTrigger)(*self.handle, &mut mode).v2_result()?;
    ...
    pub fn set_cam_parameter(&self, id: ParameterID, value: u64) -> Result<(), iCubeError> {
        ...
        unsafe {
            match self.handle.ctx.sdk() {
                SDK::V1(api) => (api.SetCamParameter)(*self.handle as _, id as u32 as _, value).v1_result(),
                SDK::V2(api) => (api.SetCamParameter)(*self.handle, id as u32 as _, value).v2_result(),
            }
        }
    }
    ...
    pub fn get_cam_parameter(&self, id: ParameterID) -> Result<u64, iCubeError> {
        ...
        unsafe {
            match self.handle.ctx.sdk() {
                SDK::V1(api) => {
                    let mut value = 0;
                    (api.GetCamParameter)(*self.handle as _, id as u32 as _, &mut value).v1_result()?;
                    Ok(value as _)
                },
                SDK::V2(api) => {
                    let mut value = 0;
                    (api.GetCamParameter)(*self.handle, id as u32 as _, &mut value).v2_result()?;
                    Ok(value)
                },
            }
        }
        ...
        unsafe {
            match self.handle.ctx.sdk() {
                SDK::V1(api) => {
                    ...
                    (api.GetCamParameterRange)(*self.handle as _, id as u32 as _, &mut prop).v1_result()?;
                    Ok(ParameterProperty::from_sdk_struct_v1(&prop))
                },
                SDK::V2(api) => {
                    let mut prop = std::mem::zeroed();
                    (api.GetCamParameterRange)(*self.handle, id as u32 as _, &mut prop).v2_result()?;
    ...
    pub fn set_exposure(&self, value: f32) -> Result<(), iCubeError> {
        ...
        unsafe {
            match self.handle.ctx.sdk() {
                SDK::V1(api) => (api.SetExposure)(*self.handle as _, value).v1_result(),
                SDK::V2(api) => (api.SetExposure)(*self.handle, value).v2_result(),
            }
        }
    }
    ...
    pub fn get_exposure(&self) -> Result<f32, iCubeError> {
        ...
        unsafe {
            match self.handle.ctx.sdk() {
                SDK::V1(api) => {
                    let mut value = 0.0;
                    (api.GetExposure)(*self.handle as _, &mut value).v1_result()?;
                    Ok(value)
                },
                SDK::V2(api) => {
                    let mut value = 0.0;
                    (api.GetExposure)(*self.handle, &mut value).v2_result()?;
                    Ok(value)
                },
            }
        }
    ...
    pub fn get_exposure_range(&self) -> Result<RangeInclusive<f32>, iCubeError> {
        ...
        unsafe {
            match self.handle.ctx.sdk() {
                SDK::V1(api) => {
                    let mut prop = std::mem::zeroed();
                    (api.GetExposureRange)(*self.handle as _, &mut prop).v1_result()?;
                    Ok(prop.nMin..=prop.nMax)
                },
                SDK::V2(api) => {
                    let mut prop = std::mem::zeroed();
                    (api.GetExposureRange)(*self.handle, &mut prop).v2_result()?;
                    Ok(prop.nMin..=prop.nMax)
                },
            }
        }
    ...
    pub fn get_param_auto_supported(&self, id: ParameterID) -> Result<bool, iCubeError> {
        ...
        unsafe {
            match self.handle.ctx.sdk() {
                SDK::V1(api) => {
                    let mut auto = 0;
                    (api.GetParamAuto)(*self.handle as _, id as u32 as _, &mut auto).v1_result()?;
                    Ok(auto != 0)
                },
                SDK::V2(api) => {
                    let mut auto = 0;
                    (api.GetParamAuto)(*self.handle, id as u32 as _, &mut auto).v2_result()?;
                    Ok(auto != 0)
                },
            }
        }
    ...
    pub fn set_param_auto(&self, id: ParameterID, value: bool) -> Result<(), iCubeError> {
        ...
        unsafe {
            match self.handle.ctx.sdk() {
                SDK::V1(api) => (api.SetParamAuto)(*self.handle as _, id as u32 as _, value as _).v1_result(),
                SDK::V2(api) => (api.SetParamAuto)(*self.handle, id as u32 as _, value as _).v2_result(),
            }
        }
    }
    ...
    pub fn set_param_one_push(&self, id: ParameterID) -> Result<(), iCubeError> {
        ...
        unsafe {
            match self.handle.ctx.sdk() {
                SDK::V1(api) => (api.SetParamOnePush)(*self.handle as _, id as u32 as _).v1_result(),
                SDK::V2(api) => (api.SetParamOnePush)(*self.handle, id as u32 as _).v2_result(),
            }
        }
    }
}
